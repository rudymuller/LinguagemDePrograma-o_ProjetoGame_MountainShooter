...
class Score:
    ...
    def save(self, game_mode: str, play_score: list[int]):
        ...
        while True:
            ...
            if game_mode == MENU_OPTION[1]:
                score = play_score[0] + play_score[1] / 2
                text = 'Enter Team name(4 Characters):'
            if game_mode == MENU_OPTION[2]:
                if play_score[0] >= play_score[1]:
                    score = play_score[0]
                    text = 'Enter Player1 name(4 Characters):'
                else:
                    score = play_score[1]
    ...
    def show(self):
        ...
        self.score_text(25, 'NAME     SCORE     DATE       ', C_ORANGE, SCORE_POS['Label'])
        db_proxy = DBProxy('DBScore')
